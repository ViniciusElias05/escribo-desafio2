...
var UserController = /*#__PURE__*/function () {
  ...
  _createClass(UserController, [{
    ...
    key: "login",
    value: function () {
      var _login = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        var user, token, ultimo_login;
    ...
    key: "findUser",
    value: function () {
      var _findUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var user;
    ...
    value: function () {
      var _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        var _req$body, nome, email, result;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _req$body = req.body, nome = _req$body.nome, email = _req$body.email;
              _context5.next = 4;
              return UserService.update(req.params.id, nome, email);
            case 4:
